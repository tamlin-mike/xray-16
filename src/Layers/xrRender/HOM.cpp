...
IC	BOOL	_visible	(Fbox& B, Fmatrix& m_xform_01)
{
	...
	Fvector2	min,max;
	float		z;
	if (xform_b0(min,max,z,m_xform_01,B.vMin.x, B.vMin.y, B.vMin.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMin.x, B.vMin.y, B.vMax.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMax.x, B.vMin.y, B.vMax.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMax.x, B.vMin.y, B.vMin.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMin.x, B.vMax.y, B.vMin.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMin.x, B.vMax.y, B.vMax.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMax.x, B.vMax.y, B.vMax.z)) return TRUE;
	if (xform_b1(min,max,z,m_xform_01,B.vMax.x, B.vMax.y, B.vMin.z)) return TRUE;
