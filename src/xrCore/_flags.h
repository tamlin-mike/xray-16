...
public:
    ...
    SelfRef zero() throw() { flags = T(0); return *this; }
    SelfRef one() throw() { flags = T(-1); return *this; }
    SelfRef invert() throw() { flags = ~flags; return *this; }
    SelfRef invert(const Self& f) throw() { flags = ~f.flags; return *this; }
