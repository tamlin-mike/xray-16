...
ICF u32 color_argb(u32 a, u32 r, u32 g, u32 b) throw() { return ((a & 0xff) << 24) | ((r & 0xff) << 16) | ((g & 0xff) << 8) | (b & 0xff); }
ICF u32 color_rgba(u32 r, u32 g, u32 b, u32 a) throw() { return color_argb(a, r, g, b); }
u32 color_argb_f(f32 a, f32 r, f32 g, f32 b) throw();
ICF u32 color_rgba_f(f32 r, f32 g, f32 b, f32 a) throw() { return color_argb_f(a, r, g, b); }
